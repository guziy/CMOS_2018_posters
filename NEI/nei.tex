...
\begin{tcolorbox}[colback=white,colframe=green!40!black,adjusted title={Main objectives}]
  ...
  \item Evaluate the net impact of the improved CRCM5 model, resulted from adding
        ...
        parameterization, on simulated climate of western Canada at 0.44$^\circ$ and 0.11$^\circ$ horizontal grid spacing.
  \item Study the impact of added modifications on simulated temperature and precipitation extremes.
  \end{enumerate}
\end{tcolorbox}
...
\adjustbox{valign=t, minipage=\linewidth}{
  ...
  \midrule
  \textbf{WC044\_default}    & Default model before implementation of the enhancements (dynamic vegetation, glaciers and hydraulic conductivity of frozen soil) at 0.44$^\circ$ horizontal grid spacing\\[0.5cm]
  \textbf{WC044\_modified}   & With parameterization enhancements at 0.44$^\circ$ \\[0.5cm]
  \textbf{WC011\_modified}   & With parameterization enhancements at 0.44$^\circ$\\
  \bottomrule
  \end{tabularx}
...
\section*{(C) Results}
\subsection*{C.1 Validation: seasonal 2m air temperature and total precipitation}
