...
\adjustbox{valign=t, minipage=0.55\linewidth}{
  ...
  \midrule
  \textbf{WC\_044\_default}    & Default model before implementation of the enhancements at 0.44$^\circ$\\[0.5cm]
...
\subsection*{Summary of enhancements to the default model configuration}
...
\begin{tikzpicture}
      ...
      \node[below= -1cm of wc044default.south west,text width=0.8\linewidth, align=left, anchor=north west]{
...
\begin{itemize}
 ...
 \item The slower growth rate of the vegetation in spring appears to be corrected by the increased resolution in WC\_011\_modified compared to WC\_044\_modified.
\end{itemize}
