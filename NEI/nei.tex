...
were improved or newly implemented in the Canadian Regional Climate Model \citep{martynov2012,huziy2017a} to
...
\begin{center}
  \begin{tikzpicture}
      ...
      \node [below=-0.45cm of wc044default.south, anchor=north] (wc044modified) {
...
\begin{center}
  \begin{tikzpicture}
      ...
      \node [below=-0.4cm of wc044default.south, anchor=north] (wc044modified) {
