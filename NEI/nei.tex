...
\adjustbox{valign=t, minipage=0.45\linewidth}{
  ...
  \captionof{figure}{\color{Green} Spatial extent of glacier fractions used as initial conditions for
...
\begin{picture}(400, 480)
    ...
    % label seasons
    % \put(10, 700) {\textbf{DJF}}
    % \put(250, 700) {\textbf{MAM}}
    % \put(510, 700) {\textbf{JJA}}
    % \put(760, 700) {\textbf{SON}}

    \put(0, 240){\includegraphics[width=\linewidth,trim={0.3cm 0 0 0.1cm},clip]{figures/seasonal_mean_TT_bias_wc_044_default}}
    \put(-20, 280) {\rotatebox{90}{WC\_044\_default}}

    \put(0, 0){\includegraphics[width=\linewidth,trim={0.3cm 0 0 0.41cm},clip]{figures/seasonal_mean_TT_bias_wc_044_modified}}
    \put(-20, 40) {\rotatebox{90}{WC\_044\_modified}}

    % \put(0, 0){\includegraphics[width=\linewidth,trim={0.3cm 0 0 0.41cm},clip]{figures/seasonal_mean_TT_bias_wc_011_modified}}
    % \put(-20, 40) {\rotatebox{90}{WC\_011\_modified}}
\end{picture}
...
\begin{picture}(400, 480)
    ...
    % \put(-20, 40) {\rotatebox{90}{WC\_011\_modified}}
\end{picture}
\captionof{figure}{\label{figure:prvalidation}\color{Green} Same as Figure \ref{figure:t2mvalidation} but for total precipitation (mm/day).}
\end{flushleft}
